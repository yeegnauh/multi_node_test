#!/bin/bash
#sh test_Ngpu_Mb_rankX.sh $RANK 32 13 1
rankX=$1
Ngpu=$2
Mb=$3
...
#for n in {1..3};do
    ...
    torchrun --nnodes=$nnode --nproc_per_node=8 --node_rank=$1 --master_addr=10.105.10.10 --master_port=29600 train.py --config ${conf_file} --launcher "torch" 2>&1 | tee -a ${log_file}
    sleep 10
done
